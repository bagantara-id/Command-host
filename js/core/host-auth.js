...
export class HostAuthenticator {
    ...
    initAuthListeners() {
        // Mengikat elemen statis di HTML
        ...
        if (btnLogin) {
            // Pemusatan Logika Eksekusi Login
            ...
            // 1. Eksekusi via Klik Kursor
            btnLogin.addEventListener('click', triggerLogin);

            // 2. PERBAIKAN MUTLAK: Eksekusi via Tombol Enter (Responsivitas Taktis)
            if (passInput) {
