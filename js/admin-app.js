...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (btnVoiceNoteAdmin) {
        ...
        const startAdminRecording = async (e) => {
            // TIDAK ADA e.preventDefault() di sini untuk menghindari pembekuan layar
            ...
            try {
                ...
                mediaRecorder.onstop = async () => {
                    ...
                    // ANTI SPAM/CRASH: Buang jika rekam kurang dari 0.8 detik
                    if (duration < 800) {
        ...
        // KUNCI MUTLAK: Menggunakan Pointer Events saja, tidak menabrak Mouse/Touch
